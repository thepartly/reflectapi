...
from reflectapi_runtime import parse_externally_tagged as _parse_externally_tagged, serialize_externally_tagged as _serialize_externally_tagged
...
class MyapiProtoPetsUpdateRequest(BaseModel):
    ...
    name: str = Field(description="identity")
    kind: myapi.model.Kind | None = Field(default=None, description="kind of pet, non nullable in the model")
    age: ReflectapiOption[int] = Field(default=None, description="age of the pet, nullable in the model")
    behaviors: ReflectapiOption[list[myapi.model.Behavior]] = Field(default=None, description="behaviors of the pet, nullable in the model")
...
class MyapiProtoPetsCreateError(RootModel[MyapiProtoPetsCreateErrorVariants]):
    ...
    def _validate(cls, data):
        return _parse_externally_tagged(data, {"Conflict": "_unit", "NotAuthorized": "_unit", "InvalidIdentity": lambda v: MyapiProtoPetsCreateErrorInvalidIdentityVariant(**v)}, (MyapiProtoPetsCreateErrorInvalidIdentityVariant,), "MyapiProtoPetsCreateError")
...
class MyapiProtoPetsListErrorInvalidCursor(BaseModel):
    ...
    kind: Literal['InvalidCursor'] = Field(default="InvalidCursor", description="Discriminator field")
...
class MyapiProtoPetsListErrorUnauthorized(BaseModel):
    ...
    kind: Literal['Unauthorized'] = Field(default="Unauthorized", description="Discriminator field")
...
class MyapiProtoPetsListErrorInternal(BaseModel):
    ...
    kind: Literal['Internal'] = Field(default="Internal", description="Discriminator field")
    message: str


class MyapiProtoPetsListError(RootModel):
    root: Annotated[Union[MyapiProtoPetsListErrorInvalidCursor, MyapiProtoPetsListErrorUnauthorized, MyapiProtoPetsListErrorInternal], Field(discriminator='kind')]
...
# Externally tagged enum using RootModel
MyapiProtoPetsUpdateErrorVariants = Union[Literal["NotFound"], Literal["NotAuthorized"], MyapiProtoPetsUpdateErrorValidationVariant]
...
class MyapiProtoPetsUpdateError(RootModel[MyapiProtoPetsUpdateErrorVariants]):
    ...
    @classmethod
    def _validate(cls, data):
        return _parse_externally_tagged(data, {"NotFound": "_unit", "NotAuthorized": "_unit", "Validation": lambda v: MyapiProtoPetsUpdateErrorValidationVariant(field_0=v)}, (MyapiProtoPetsUpdateErrorValidationVariant,), "MyapiProtoPetsUpdateError")

    @model_serializer
    def _serialize(self):
        return _serialize_externally_tagged(self.root, {"NotFound": (lambda r: r == "NotFound", lambda r: "NotFound"), "NotAuthorized": (lambda r: r == "NotAuthorized", lambda r: "NotAuthorized"), "Validation": (lambda r: isinstance(r, MyapiProtoPetsUpdateErrorValidationVariant), lambda r: {"Validation": r.field_0})}, "MyapiProtoPetsUpdateError")
...
class MyapiProtoValidationError(RootModel[MyapiProtoValidationErrorVariants]):
    ...
    @classmethod
    def _validate(cls, data):
        return _parse_externally_tagged(data, {"ValidationA": lambda v: MyapiProtoValidationErrorValidationAVariant(field_0=v)}, (MyapiProtoValidationErrorValidationAVariant,), "MyapiProtoValidationError")

    @model_serializer
    def _serialize(self):
        return _serialize_externally_tagged(self.root, {"ValidationA": (lambda r: isinstance(r, MyapiProtoValidationErrorValidationAVariant), lambda r: {"ValidationA": r.field_0})}, "MyapiProtoValidationError")
...
__all__ = ["Headers", "InternalError", "MyapiProtoHeaders", "MyapiProtoInternalError", "MyapiProtoPaginated", "MyapiProtoPetsCreateError", "MyapiProtoPetsCreateErrorInvalidIdentityVariant", "MyapiProtoPetsListError", "MyapiProtoPetsListErrorInternal", "MyapiProtoPetsListErrorInvalidCursor", "MyapiProtoPetsListErrorUnauthorized", "MyapiProtoPetsListRequest", "MyapiProtoPetsRemoveError", "MyapiProtoPetsRemoveRequest", "MyapiProtoPetsUpdateError", "MyapiProtoPetsUpdateErrorValidationVariant", "MyapiProtoPetsUpdateRequest", "MyapiProtoValidationA", "MyapiProtoValidationError", "MyapiProtoValidationErrorValidationAVariant", "Paginated", "PetsCreateError", "PetsCreateErrorInvalidIdentityVariant", "PetsListError", "PetsListErrorInternal", "PetsListErrorInvalidCursor", "PetsListErrorUnauthorized", "PetsListRequest", "PetsRemoveError", "PetsRemoveRequest", "PetsUpdateError", "PetsUpdateErrorValidationVariant", "PetsUpdateRequest", "ValidationA", "ValidationError", "ValidationErrorValidationAVariant"]
