...
class TestEdgeCases:
    ...
    def test_pet_very_long_name(self):
        ...
        long_name = "a" * 1000
        pet = Pet(name=long_name, kind=PetKindDog(type="dog", breed="Labrador"))
        assert pet.name == long_name

    def test_pet_unicode_name(self):
        """Test pet with unicode characters in name."""
        unicode_name = "🐕 Wölfgang 犬"
        pet = Pet(name=unicode_name, kind=PetKindDog(type="dog", breed="Labrador"))
    ...
    def test_pet_empty_behaviors_list(self):
        ...
        pet = Pet(
            name="Test", kind=PetKindDog(type="dog", breed="Labrador"), behaviors=[]
        )
    ...
    def test_pet_duplicate_behaviors(self):
        ...
        roots = [
            ...
            if hasattr(b.root, "field_0")
            else str(b.root)
            for b in pet.behaviors
        ]
...
class TestSerialization:
    ...
    def test_partial_model_updates(self):
        ...
        original_pet = Pet(
            name="Original", kind=PetKindDog(type="dog", breed="Labrador"), age=5
        )
