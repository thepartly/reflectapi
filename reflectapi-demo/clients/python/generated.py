...
ReflectapiOption = Union[ReflectapiOptionUndefined, ReflectapiOptionNone, ReflectapiOptionSome]
...
try:
    ...
    ReflectapiOption.model_rebuild()
...
def create_reflectapioption_response(value: ReflectapiOption) -> ApiResponse[ReflectapiOption]:
    """Create a mock ApiResponse for ReflectapiOption."""
    return create_api_response(value)
