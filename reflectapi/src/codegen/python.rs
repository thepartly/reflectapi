...
# Third-party imports
from pydantic import BaseModel, ConfigDict{% if has_discriminated_unions %}, Field{% endif %}{% if has_externally_tagged_enums %}, RootModel, model_validator, model_serializer{% endif %}
