...
from reflectapi_runtime import (
    ClientBase, AsyncClientBase,
    BearerTokenAuth, APIKeyAuth, BasicAuth, OAuth2ClientCredentialsAuth,
...
class TestConcurrentAuthEdgeCases:
    ...
    async def test_concurrent_oauth2_token_requests(self):
        ...
        with patch('httpx.AsyncClient.post') as mock_post:
            ...
            assert all(req.headers["Authorization"] == "Bearer test_token" for req in requests)
