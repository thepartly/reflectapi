...
pub struct Schema {
    ...
    /// Shared modules per codegen language. Types from these modules are assumed
    /// to already exist as dependencies and will not be generated by the codegen.
    /// Keys are language identifiers (e.g. `"rust"`, `"typescript"`).
    #[serde(skip_serializing_if = "BTreeMap::is_empty", default)]
    pub shared_modules: BTreeMap<String, BTreeSet<String>>,
}
